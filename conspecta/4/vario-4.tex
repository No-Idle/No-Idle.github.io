...
\begin{document}
    ...
    \note{
    Хотя лемма зовётся формулой для вариации, правильнее было бы её назвать формулой для производной, так как вариация $\delta J[x_0, h]$ равна выражению из~(\cref{vario-formula}) с точностью до $o(|h|)$.
    }
