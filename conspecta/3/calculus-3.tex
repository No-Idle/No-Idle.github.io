...
\begin{document}
    ...
    \theorem{
        ...
        Утверждается, что $\gamma$ аддитивна (это можно было бы доказать при помощи интеграла, но интеграл Римана здесь не подойдёт)
    }
    ...
    \lemma{
        ...
        \provehere{
            ...
            Обозначим $A = \defset{x}{f(x) \ne 0}$ (кстати, носитель $\supp f \bydef \defset{x}{f(x) \ne 0}$).
    ...
    \precaution{
        ...
        рассмотрев на $\mathcal{P}(\R)$ $A_n = (n, +\infty)$ видим, что хотя $A_1 \supset A_2 \supset \dots$, и $\mu\left(\bigcap\limits_{i \in \N}A_i\right) = \mu(\o) = 0 \ne \lim\limits_{n \to \infty}\mu(A_n) = \infty$.
    }
    \theorem{
    ...
    \theorem[Лебег-Каратеодори]{
        ...
        \provebullets{
            ...
            Можно считать, что $\forall i: c_i \subset e$ (пересекая каждое из $c_i$ с $e$).
            ...
            \item Наконец, для доказательства второго дополнения сошлёмся на четвёртый пункт свойств меры~(\cref{outer-measure}).
        }
    }
