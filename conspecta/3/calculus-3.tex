...
%    Если же $\overline{\mu}(E) = \infty$
    ...
    \fact{
        ...
        \provehere{\down\numbers{
            ...
            Отметим, что $A_n$ измеримы, и пусть $A \coloneqq \bigcap\limits_{n = 1}^{\infty}A_n$. На множестве $A$ нет сходимости: $\begin{tikzcd}[ampersand replacement=\&,column sep=small,cramped]
                                                                                                                                         f_n \arrow[r, "/"{marking, allow upside down}] \& f
            \end{tikzcd}$.
