...
%        Тогда из локальной липшицевости $\mu_m^*(F(e)) = 0$.
    ...
    Разницы особой нет (конечно, предполагается, что $E \in \Sigma$), можно считать и так, и так.
    \theorem[Хан]{
        ...
        \provehere{
            ...
            \bullets{
                ...
                Теперь заметим, что $\overline{b_1} \supset \overline{b_2} \subset \cdots$ Положим $E \coloneqq \bigcap\limits_{k = 1}^{\infty}\overline{b_k}$.
                В силу монотонной непрерывности $\mu(E) = \lim\limits_{k \to \infty}\mu(\overline{b_k}) = M$.
