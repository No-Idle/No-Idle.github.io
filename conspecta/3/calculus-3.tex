...
%    Если же $\overline{\mu}(E) = \infty$
    ...
    \theorem{
        ...
        \provehere{
            ...
            (Если множество неограниченное, то максимального включения среди всех кубов может не найтись, надо ограничить их размер)
        }
    }
