...
%    }
    ...
    \fact{
        \down\numbers{
            ...
            \item Из сходимости по мере $f_n \underset{n \to \infty}{\overset{\mu}\Map} f$ следует, что найдётся сходящаяся подпоследовательность: $\exists n_1 < n_2 < \dots$, таких, что $f_{n_k} \almost{k \to \infty} f$.
        }
        \provehere{\down\numbers{
