...
\begin{document}
    ...
    Пускай $\phi: \mathcal{A} \map [0, +\infty]$ --- аддитивная функция множеств. $\phi$ называется \textit{счётно аддитивной}, если для $a \in \mathcal{A}, \{a_j\}_{j=1}^{\infty} \subset \mathcal{A}$ верно $a = \bigsqcup\limits_{j=1}^{\infty} \then \phi(a) = \sum\limits_{j = 1}^{\infty}\phi(a_j)$.
    \theorem{
        ...
        \provehere{
            \indentlemma{
                ...
                \numbers{
                    ...
                    \item Если $Q \subset \bigcup\limits_{j=1}^{k}$ (условий на дизъюнктность нет), то $V_n(Q) \le \sum\limits_{j = 1}^{k}V_n(Q_j)$.
                }
            }        {
                \numbers{
...
%    Если же $\overline{\mu}(E) = \infty$
    ...
    Свёртка определена в тех точках, где интеграл конечен.
    }
    ...
    \theorem{
    Если $f$ лежит в $L^1(\R^n)$, $g \in L^p(\R^n)$, где $1 \le p \le \infty$, то $\|f * g\|_{L^p(\R^n)} \le \|f\|_{L^1(\R^n)}\|g\|_{L^p(\R^n)}$.
    }
\end{document}
