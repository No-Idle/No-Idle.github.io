...
%    Если же $\overline{\mu}(E) = \infty$
    ...
    \theorem[Абсолютная непрерывность интеграла]{
        ...
        \provehere{
            ...
            Положим $E \coloneqq \bigcap\limits_{n \in \N}E_n$. Из счётной аддитивности $\int\limits_{E}|f|\d\mu = \lim\limits_{n \to \infty}\int\limits_{E_n}|f|\d\mu$, но левый интеграл равен нулю, как интеграл по множеству меры нуль.
        }
    }
    \note{
